...
import {
  ...
  KanbanSquare, LayoutDashboard, ReceiptText, Settings, Stamp, UserCog, Users, Wallet, Wrench, type LucideIcon,
} from 'lucide-react';
...
const ICONS: Record<string, LucideIcon> = {
  ...
  ArrowDownCircle, ArrowUpCircle, BellRing, Stamp, Wrench,
};
