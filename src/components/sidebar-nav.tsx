...
import {
  ...
  KanbanSquare, LayoutDashboard, ReceiptText, Scale, Settings, Stamp, UserCog, Users, Wallet, Wrench, type LucideIcon,
} from 'lucide-react';
...
const ICONS: Record<string, LucideIcon> = {
  ...
  ArrowDownCircle, ArrowUpCircle, BellRing, Scale, Stamp, Wrench,
};
